                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            <div
                                                ...
                                                We've received a request to reset the password for your account. To
                                                create a new password, click the button below.
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            <div
                                                ...
                                                Just so you know: You have <strong>1 hour</strong> to pick your
                                                password. After that, you'll have to ask for a new one. <br><br>
                                                If you didn't request this, you can ignore this email or let us know.
                                                Your password won't change until you create a new password. <br><br>
