                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            <div
                                                ...
                                                Hello <span
                                                    style="color: #2F67F6;">{{$data['user']->name}}</span>,<br></br>
                                                Your account has been created on our app. Below are your system
                                                generated credentials, please change the password immediately after
                                                login. Please use the below to log in to your account.
                                                <table style="font-size:15px;margin-top:20px;width:100%;">
                                                    <tr>
                                                ...
                                                <tr>
                                                    <a href="#" target="_blank">
                                                        <td align="center" bgcolor="#2F67F6" role="presentation"
                                                            style="border:none; border-radius:3px;color:#ffffff;cursor:pointer;padding:15px 25px;"
                                                            valign="middle">
                                                            <p
                                                                style="color:#ffffff;font-family:'Helvetica Neue',Arial,sans-serif;font-size:15px;font-weight:normal;line-height:120%;Margin:0;text-decoration:none;text-transform:none;">
                                                                LOGIN TO ACCOUNT
                                                            </p>
                                                        </td>
                                                    </a>
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            <div
                                                ...
                                                <br><br>
                                                <a href="#"></a> <br><br>
                                                If you didn't register for an account using this e-mail address, you can
                                                safely ignore this message. If you want to report abuse of your e-mail
                                                address, please <a href="mailto:#"
                                                    style="text-decoration: none;">contact us</a>. <br><br>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                                    ...
                                                    <tr>
                                                        <td align="center"
                                                            ...
                                                            <div
                                                                style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:11px;font-weight:300;line-height:1;text-align:center;color:#575757;">
                                                    ...
                                                    <tr>
                                                        <td align="center"
                                                            style="font-size:0px;padding-top:10px;word-break:break-word;">
                                                            <div
                                                                style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:11px;font-weight:300;line-height:1;text-align:center;color:#575757;">
                                                                &copy; {{$fullYear}} Xxxxxx. All rights reserved.
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
